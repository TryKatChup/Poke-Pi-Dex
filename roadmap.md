...
- [ ] registrare per ciascuna descrizione in Inglese la traccia audio letta da un bot (https://www.youtube.com/watch?v=rjlOJjX-6Ug) Bot: [Text To Speech Online](http://texttospeechrobot.com/) + [PKMN DB](https://pokemondb.net/pokedex/blastoise)
