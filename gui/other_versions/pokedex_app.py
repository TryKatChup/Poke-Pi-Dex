...
class App:
    def __init__(self, window, window_title):
        ...
        self.check_fullscreen = tk.Checkbutton(master=self.frame_top_right, text="Fullscreen", variable=self.fullscreen,
                                               onvalue=True, offvalue=False)
        self.check_fullscreen.pack(side=tk.TOP, pady=(50, 0))
        # Name
